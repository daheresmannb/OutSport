...
public class Constantes {
    public static String obtener_usuario_x_id ="http://pillan.inf.uct.cl/~dpalma/OUTSPORTWS/Usuario/obtener_usuario_por_id.php?idUsuario=";
    public static String obtener_usuarios = "http://pillan.inf.uct.cl/~dpalma/OUTSPORTWS/Usuario/obtener_usuarios.php";
    public static String obtener_usuario_x_correo = "http://pillan.inf.uct.cl/~dpalma/OUTSPORTWS/Usuario/obtener_usuario_por_correo.php?correo=";
